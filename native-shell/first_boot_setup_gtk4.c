...
typedef struct {
    ...
    GtkWidget *recovery_panel, *recovery_otp, *recovery_result;
...
static void set_page(Oobe *o, int page);
...
static void show_danedesk_recovery(Oobe *o) {
    gtk_widget_set_visible(o->stack, FALSE);
    gtk_widget_set_visible(o->recovery_panel, TRUE);
    gtk_widget_set_visible(o->back, FALSE);
    gtk_widget_set_visible(o->next, FALSE);
    gtk_widget_set_visible(o->lock_icon, FALSE);
    gtk_label_set_text(GTK_LABEL(o->stage), "Recuperación DaneDesk");
    gtk_label_set_text(GTK_LABEL(o->status), "Este dispositivo necesita autorización del propietario para continuar.");
...
static void recovery_otp_clicked(GtkButton *button, gpointer data) {
    ...
    gtk_widget_set_visible(o->recovery_panel, FALSE); gtk_widget_set_visible(o->stack, TRUE); set_page(o, 14);
}
