...
static void load_css(Oobe *o) {
    ...
    const char *css =
        ...
        ".oobe-modal { background: rgba(255,255,255,.80); border: 1px solid rgba(255,255,255,.92); border-radius: 4px; padding: 18px 22px 16px 22px; box-shadow: 0 18px 50px rgba(13,45,42,.18); }"
        ...
        ".oobe-page { background: rgba(255,255,255,.22); border: 1px solid rgba(255,255,255,.58); padding: 12px; } .oobe-footer { min-height: 42px; } scrolledwindow undershoot { background: transparent; }"
