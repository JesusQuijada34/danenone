...
static void load_css(Oobe *o) {
    ...
    const char *css =
        ...
        ".dark .oobe-page, .dark .summary-card, .dark .status-card, .dark .network-list { background: rgba(13,23,22,.42); border-color: rgba(255,255,255,.18); } .dark .storage-device-list, .dark .storage-options, .dark .storage-tools { background: rgba(13,23,22,.32); border-color: rgba(255,255,255,.18); }"
