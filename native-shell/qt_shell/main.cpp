...
private:
    ...
    void buildDesktop() {
        ...
        addShortcut(QStringLiteral("Foundstore"), QIcon(assetPath(QStringLiteral("/usr/share/icons/danenone/apps/scalable/danenone-foundstore.svg"), QStringLiteral("/home/ubuntu/danenone/native-shell/assets/icons/danenone-foundstore.svg"))), QStringLiteral("xdg-open https://imfoundstore.onrender.com"));
    ...
    void buildLauncher() {
        ...
        addLauncherApp(m_appsList, QStringLiteral("Foundstore"), QIcon(assetPath(QStringLiteral("/usr/share/icons/danenone/apps/scalable/danenone-foundstore.svg"), QStringLiteral("/home/ubuntu/danenone/native-shell/assets/icons/danenone-foundstore.svg"))), QStringLiteral("xdg-open https://imfoundstore.onrender.com"));
